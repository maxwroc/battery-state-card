...
| secondary_info_text | string |  | v1.1.0 | Text to be shown when battery is charging. To show it you need to have `secondary_info: charging` property set on entity. ([example](#charging-state-indicators))
