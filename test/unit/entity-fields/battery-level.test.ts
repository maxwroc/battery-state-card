...
describe("Battery level", () => {
    ...
    test("is equal value_override setting when it is provided", () => {
        ...
        const { state, level, unit } = getBatteryLevel({ entity: "any", value_override: "45" }, hassMock.hass, undefined);
    ...
    test("doesn't throw an exception when attributes are not set on entity", () => {
        ...
        const { state, level, unit } = getBatteryLevel({ entity: "mocked_entity" }, hassMock.hass, hassMock.createAccessor("mocked_entity"));
    ...
    test("is taken from attribute but attribute is missing", () => {
        ...
        const { state, level, unit } = getBatteryLevel({ entity: "mocked_entity", attribute: "battery_state_missing" }, hassMock.hass, hassMock.createAccessor("mocked_entity"));
    ...
    test("is taken from attribute", () => {
        ...
        const { state, level, unit } = getBatteryLevel({ entity: "mocked_entity", attribute: "battery_state" }, hassMock.hass, hassMock.createAccessor("mocked_entity"));
    ...
    test("is taken from attribute - value includes percentage", () => {
        ...
        const { state, level } = getBatteryLevel({ entity: "mocked_entity", attribute: "battery_state" }, hassMock.hass, hassMock.createAccessor("mocked_entity"));
    ...
    test("is taken from state - value includes percentage", () => {
        ...
        const { state, level } = getBatteryLevel({ entity: "mocked_entity" }, hassMock.hass, hassMock.createAccessor("mocked_entity"));
    ...
    test("is taken from default locations - non battery entity", () => {
        ...
        const { state, level } = getBatteryLevel({ entity: "mocked_entity", non_battery_entity: true }, hassMock.hass, hassMock.createAccessor("mocked_entity"));
    ...
    test("multiplier applied", () => {
        ...
        const { state, level } = getBatteryLevel({ entity: "mocked_entity", multiplier: 100 }, hassMock.hass, hassMock.createAccessor("mocked_entity"));
    ...
    ("round applied", (entityState: string, round: number, expectedResult: string) => {
        ...
        const { state, level } = getBatteryLevel({ entity: "mocked_entity", round }, hassMock.hass, hassMock.createAccessor("mocked_entity"));
    ...
    ("state map applied", (entityState: string, expectedState: string, expectedLevel: number | undefined, expectedUnit: string | undefined, display?: string) => {
        ...
        const { state, level, unit } = getBatteryLevel({ entity: "mocked_entity", state_map: [ { from: "ok", to: "100" }, { from: "empty", to: "0" }, { from: "charge", to: "0", display } ] }, hassMock.hass, hassMock.createAccessor("mocked_entity"));
    ...
    test.each([
        [undefined, "45", "dbm", { state: "45", level: 45, unit: "[dbm]" }],
        [true, "45", "dbm", { state: "45", level: 45, unit: "[dbm]" }],
        [false, "45", "dbm", { state: "45", level: 45, unit: "%" }],
        [true, "45", "dbm", { state: "56", level: 56, unit: "%" }, [ { from: "45", to: "56" } ]],
        [true, "45", "dbm", { state: "Low", level: 45, unit: undefined }, [ { from: "45", to: "45", display: "Low" } ]],
        [true, "45.4", "dbm", { state: "45,4", level: 45.4, unit: "[dbm]" }, undefined, ","],
    ])
    ("default HA formatting", (defaultStateFormatting: boolean | undefined, entityState: string, unitOfMeasurement: string, expected: { state: string, level: number, unit?: string }, stateMap: IConvert[] | undefined = undefined, decimalPoint: string = ".") => {
        ...
        const hassMock = new HomeAssistantMock(true);
        hassMock.addEntity("Mocked entity", entityState);
        hassMock.mockFunc("formatEntityState", (entityData: any, stateOverride?: string) => {
            const stateVal = stateOverride ?? entityData.state;
            return `${stateVal.replace(".", decimalPoint)} [${unitOfMeasurement}]`;
        });

        const { state, level, unit } = getBatteryLevel({ entity: "mocked_entity", default_state_formatting: defaultStateFormatting, state_map: stateMap }, hassMock.hass, hassMock.createAccessor("mocked_entity"));
    ...
    test.each([
        ...
        const { unit } = getBatteryLevel({ entity: entity.entity_id, default_state_formatting: false, unit: configOverride }, hassMock.hass, hassMock.createAccessor(entity.entity_id));
    ...
    test.each([
        ...
        const { unit } = getBatteryLevel({ entity: entity.entity_id, default_state_formatting: false, unit: configOverride, value_override: "{state}" }, hassMock.hass, hassMock.createAccessor(entity.entity_id));
    ...
    test.each([
        ...
        const { state } = getBatteryLevel({ entity: entity.entity_id, default_state_formatting: false, unit: undefined}, hassMock.hass, hassMock.createAccessor(entity.entity_id));
    ...
    test("number in the attribute value", () => {
        ...
        const { state } = getBatteryLevel({ entity: entity.entity_id, attribute: "custom_attribute"}, hassMock.hass, hassMock.createAccessor(entity.entity_id));
    ...
    ("default HA formatting - various formatted states", (formattedResult: string, expected: { state: string, level: number, unit?: string }) => {
        ...
        const { state, level, unit } = getBatteryLevel({ entity: "mocked_entity" }, hassMock.hass, hassMock.createAccessor(entity.entity_id));
